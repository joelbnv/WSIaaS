    ...
    def transform(self, data):
        if self.vendor == "shopify":
            if self.used_extraction_strategy == "ShopifyAPIStrategy":
                ...
                # Write data as-is to a file
                with open("extraction_results/result_transformed.json", "w") as file: 
                ...
                raise ValueError("Transformation Strategy not Supported!! / No transformation strategy was defined")
